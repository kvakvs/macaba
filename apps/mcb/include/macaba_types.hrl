...
-type mcb_mnesia_object() :: mcb_site_config | mcb_board_dynamic
                           | mcb_thread_dynamic.
-type mcb_mnesia_record() :: #mcb_site_config{} | #mcb_board_dynamic{}
                           | #mcb_thread_dynamic{}.
...
-type mcb_riak_object()   :: mcb_thread | mcb_post
                           | mcb_attachment | mcb_attachment_body
                           | mcb_mnesia_object().
-type mcb_riak_record()   :: #mcb_thread{} | #mcb_post{}
                           | #mcb_attachment{} | #mcb_attachment_body{}
                           | mcb_mnesia_record().
-type mcb_db_object()     :: mcb_riak_object().
